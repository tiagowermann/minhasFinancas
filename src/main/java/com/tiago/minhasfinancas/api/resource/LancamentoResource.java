...
import com.tiago.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.tiago.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	@PutMapping("{id}") // serve para atualizar no servidor
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto ) {
		return service.obterPorId(id).map( entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi pssível atualizar o status do lançamento, envie um status válido.");
			}
